	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.foolObjects={
			...
			'Mine':{name:'Scroll',desc:'The scroll to success.',icon:3},
			'Factory':{name:'Building',desc:'It\'s a strange building. What\'s inside?',icon:4},
			...
			'Antimatter condenser':{name:'Dogecoin',desc:'A virtual currency, already replacing regular money in some small countries.',icon:12},
		...
		*/
		...
		Game.dragonLevels=[
			...
			{name:'Krumblor, cookie dragon',action:'Bake dragon cookie<br><small>Delicious!</small>',pic:6,
				...
				buy:function(){for (var i in Game.Objects){Game.Objects[i].sacrifice(200);}Game.Unlock('Dragon cookie');},
			...
			{name:'Krumblor, cookie dragon',action:'Train secondary aura<br><small>Lets you use two dragon auras simultaneously</small>',pic:7,
				cost:function(){var fail=0;for (var i in Game.Objects){if (Game.Objects[i].amount<550) fail=1;}return (fail==0);},
				buy:function(){for (var i in Game.Objects){Game.Objects[i].sacrifice(550);}},
